...
(function ($) {
    ...
    function exitFullscreen() { // eslint-disable-line
    ...
    Magnify.prototype = {
        ...
        close: function (el) {  // eslint-disable-line
        ...
        getImgGroup: function (list, imgSrc) {
            ...
            $(list).each(function (index, item) {   // eslint-disable-line
        ...
        zoomTo: function (ratio, origin, e) {   // eslint-disable-line
            var $image = isIE8() ? this.$stage.find('.magnify-image') : this.$image,
                $stage = this.$stage,
                imgData = {
